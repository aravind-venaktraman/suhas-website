...
export default function MusicSection({ appleMusicLink, spotifyLink, youtubeLink }) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setOverlayOpacity(0.1 + progress * 0.45);
    };
  ...
  return (
    <section ref={sectionRef} className="relative bg-black">
      ...
      <div className="relative" style={{ zIndex: 1, marginTop: '-100vh' }}>
        ...
        {/* ── Landing: Fractals Hero + Spotify Embed ── */}
        <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 text-center relative overflow-hidden">
